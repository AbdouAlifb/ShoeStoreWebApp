				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
							<div id="colorlib-logo"><a href="{{ route('admin.house') }}">Shoe Store</a></div>
						</div>
					...
					<div class="row">
						...
						<ul>
					<li><a href="{{ route('admin.house') }}">Home</a></li>
							<li class="has-dropdown">
								<a href="{{ route('admin.men') }}" id="men-link">Men</a>
							
					</li>
							<li><a href="{{ route('admin.women') }}">Women</a></li>
							<li><a href="{{ route('admin.home') }}">Config Panels</a></li>
							<li>
						...
						<div class="col-sm-8 offset-sm-2 text-center">
							<div class="row">
								<div class="owl-carousel2">
									<div class="item">
										<div class="col">
											<h3><a href="#">Welcome Admin </a></h3>
										</div>
									</div>
									<div class="item">
										<div class="col">
											<h3><a href="#">From here YOU TAKE CONTROLE !!!!</a></h3>
										</div>
									</div>
								</div>
							</div>
...
<!-- Add this inside your JavaScript section -->
<!-- Add this inside your JavaScript section -->
